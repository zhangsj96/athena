...
kappa_pf_table = np.ones_like(kappa_pf_table)*density_unit*length_unit                      # [\rho_0*L_0]
kappa_rf_table = np.ones_like(kappa_pf_table)*density_unit*length_unit                      # [\rho_0*L_0]
kappa_sf_table *= density_unit*length_unit*0.                  # [\rho_0*L_0]

kappa_pf_table[:,1] = 1000*kappa_pf_table[:,0]
kappa_rf_table[:,1] = 1000*kappa_rf_table[:,0]
